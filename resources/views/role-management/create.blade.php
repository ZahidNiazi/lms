    ...
    <div class="card shadow-sm rounded-4">
        <div class="card-body">
            <form action="{{ route('role-management.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold d-block mb-2">Assign Permissions</label>
                    <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 mb-2">
                                @foreach ($chunk as $perm)
                                    <div class="form-check mb-1">
                                        ...
                                        <label for="permission-{{ $perm->id }}" class="form-check-label text-capitalize">
                                            {{ $perm->name }}
                                        </label>
                                    </div>
                                @endforeach
