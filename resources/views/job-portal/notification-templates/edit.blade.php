...
<head>
    ...
    <title>Job Portal - Edit Notification Template</title>
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="form-card">
                    <h4 class="mb-4">
                        <i class="bi bi-envelope me-2"></i>Edit Notification Template: {{ $template->name }}
                    </h4>
                    ...
                    <form method="POST" action="{{ route('job-portal.notification-templates.update', $template->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="trigger_event" name="trigger_event" required>
                                ...
                                @foreach($triggerEvents as $key => $label)
                                    <option value="{{ $key }}" {{ old('trigger_event', $template->trigger_event) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3" id="subject-field" style="{{ $template->type === 'email' ? 'display: block;' : 'display: none;' }}">
