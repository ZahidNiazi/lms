...
<head>
    ...
    <title>Job Portal - Add Interview Location</title>
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="form-card">
                    <h4 class="mb-4">
                        <i class="bi bi-geo-alt me-2"></i>Add New Interview Location
                    </h4>
                    ...
                    <form method="POST" action="{{ route('job-portal.interview-locations.store') }}">
                        @csrf
