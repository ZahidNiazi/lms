            ...
            <div class="col-md-2 sidebar p-0">
                <div class="p-3">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link active" href="{{ route('sms.hr') }}">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">HR Administration</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted">Manage awards, warnings, termination, and assessments</p>
                </div>
                <div class="card-body">
                    <div class="text-center py-4">
                        <i class="bi bi-award display-1 text-muted"></i>
                        <h5 class="mt-3">HR Administration</h5>
                        <p class="text-muted">HR management functionality will be implemented here.</p>
                    </div>
                </div>
            </div>
        </div>
