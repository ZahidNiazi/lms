...
<head>
    ...
    <title>SMS - Postings Management</title>
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <h3>Postings Management</h3>
                <p class="text-muted">Manage student postings to Police, MNDF, and other units.</p>
