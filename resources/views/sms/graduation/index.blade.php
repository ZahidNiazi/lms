...
<head>
    ...
    <title>SMS - Graduation Management</title>
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <h3>Graduation Management</h3>
                <p class="text-muted">Manage student graduation, postings to Police, MNDF, and other units.</p>
