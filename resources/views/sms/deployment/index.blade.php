            ...
            <div class="col-md-2 sidebar p-0">
                <div class="p-3">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link active" href="{{ route('sms.deployment') }}">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Post Graduation Deployment</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Student Deployment</h5>
                    <p class="text-muted">Manage post-graduation deployment to MNDF, Police, and other units</p>
                </div>
                <div class="card-body">
                    <div class="text-center py-4">
                        <i class="bi bi-geo-alt display-1 text-muted"></i>
                        <h5 class="mt-3">Deployment Management</h5>
                        <p class="text-muted">Deployment management functionality will be implemented here.</p>
                    </div>
                </div>
            </div>
        </div>
